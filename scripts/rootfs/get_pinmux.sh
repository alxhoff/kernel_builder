...
echo "pinmux/bootloader/" >> .git/info/sparse-checkout
git pull origin master

# --- Copy and merge bootloader directory ---
echo "Merging bootloader directory into $L4T_DIR/bootloader"
cp -rT "$TMP_DIR/pinmux/bootloader" "$L4T_DIR/bootloader"
