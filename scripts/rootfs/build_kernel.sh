...
for DRIVER in $THIRD_PARTY_DRIVERS; do
	...
	echo "$TEGRA_DIR/$BUILD_SCRIPT --kernel-src $KERNEL_SRC_ROOT --localversion"
	$TEGRA_DIR/$BUILD_SCRIPT --kernel-src $KERNEL_SRC_ROOT --localversion
done
